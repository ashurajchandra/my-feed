...
const SignUp: React.FC<{ updatePopUpContent?: () => void }> = ({
  updatePopUpContent,
}) => {
      ...
      <div className='flex flex-col items-center justify-center min-h-[calc(100vh-80px)] px-4'>
        <div className='w-[498px] h-[653px] pt-[11px] pb-[55px] pl-[11px] pr-[11px] bg-[#EBEBEB] rounded-[30px]'>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className='mb-[15px]'>
                <label
                  ...
                  className='block text-[14px] font-semibold text-[#000000] mb-[6px]'>
              ...
              <div className='mb-[15px]'>
                <label
                  htmlFor='password'
                  className='block text-[14px] font-semibold text-[#000000] mb-[10px]'>
                  {LABEL.PASSWORD}
                </label>
                <input
                  type='password'
          ...
          <div className='mt-[15px] mb-[19px] text-center'>
            <span className='text-[#00000099] text-[14px] font-medium font-inter'>
              {LABEL.ALREADY_HAVE_AN_ACCOUNT}{" "}
            </span>
            {updatePopUpContent ? (
              <button
                className='text-[#5057EA] text-[14px] font-semibold font-inter outline-none bg-transparent'
                onClick={updatePopUpContent}>
                {LABEL.SIGN_IN}
              </button>
            ) : (
              <Link
                to='/signin'
                className='text-[#5057EA] text-[14px] font-semibold font-inter'>
                {LABEL.SIGN_IN}
              </Link>
            )}
          </div>
