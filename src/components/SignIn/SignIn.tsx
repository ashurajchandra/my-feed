...
const SignIn: React.FC<{ updatePopUpContent?: () => void }> = ({ updatePopUpContent }) => {
        ...
        <div className="w-[498px] h-[572px] pt-[11px] pb-[55px] pl-[11px] pr-[11px] bg-[#EBEBEB] rounded-[30px]">
          ...
          <div className='flex flex-col items-center justify-center mb-[65px]'> 
            ...
            <div className="mt-[15px] mb-[19px] text-center">
              ...
              {updatePopUpContent ? 
              <button className="text-[#00000099] text-[#5057EA] text-[14px] font-semibold font-inter outline-none bg-transparent" onClick={updatePopUpContent}>
                {LABEL.SIGN_UP}
              </button>
              :
