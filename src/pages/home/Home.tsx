...
const Home: React.FC = () => {
  ...
  const { displayedData, isFetching, hasMore, lastElementRef } = usePaginated({
    data: posts,
  ...
  return (
    <div className='min-h-screen'>
      ...
      <Popup
        ...
        {popUpContent === "signIn" && (
          <SignIn updatePopUpContent={() => setPopUpContent("signUp")} />
        )}
        {popUpContent === "signUp" && (
          <SignUp updatePopUpContent={() => setPopUpContent("signIn")} />
        )}
      </Popup>
    </div>
  );
